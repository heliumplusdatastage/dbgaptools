...
STUDY_PART_SET_FIELD  = 'STUDY_PARTICIPANT_SET'
...
READ_DBGAP_COLUMN_ORDER = [VARIABLE_ACC_FIELD, VARIABLE_VERSION_FIELD, DATASET_ACC_FIELD, DATASET_VERSION_FIELD,
                           STUDY_PART_SET_FIELD, STUDY_ACC_FIELD, STUDY_VERSION_FIELD, DATASET_NAME_FIELD,
...
REQUIRED_JSON_COLS = [VARIABLE_ACC_FIELD, VARIABLE_VERSION_FIELD, DATASET_ACC_FIELD, DATASET_VERSION_FIELD,
                      STUDY_ACC_FIELD, STUDY_VERSION_FIELD, DATASET_NAME_FIELD, VARNAME_FIELD]

# Required data columns in json output
OPTIONAL_JSON_COLS = [STUDY_PART_SET_FIELD, DATASET_DESC_FIELD,
